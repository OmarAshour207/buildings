    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('buildings.index') }}"><i class="fa fa-user"></i> التحكم في العقارات </a></li>
                <li class="active"><i class="fa fa-plus"></i>  أضافه عقار </li>
            </ol>
        </section>
                            ...
                            <form action="{{ route('buildings.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group" >
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="2">في انتظار التفعيل  </option>
