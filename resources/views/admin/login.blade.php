...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('dashboard_files/css/square/blue.css') }}">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"> قم بتسجيل دخولك </p>
    ...
    <a href=" {{ url('adminpanel/forgot/password') }} ">لقد نسيت كلمة السر</a><br>
